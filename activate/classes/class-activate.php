...
namespace DPUK_AC\Classes\Activate;
...
class Activate {
	...
	public function get_row_notice() {
		...
		if ( ! Classes\php()->version() ) {
			add_action( 'after_plugin_row_' . DPUKAC_BASENAME, [ $this, 'row_notice' ], 5, 3 );
		}
	}
	...
	public function row_notice( $plugin_file, $plugin_data, $status ) {
		...
		?>
		<style>
			.plugins tr[data-plugin='<?php echo DPUKAC_BASENAME; ?>'] th,
			.plugins tr[data-plugin='<?php echo DPUKAC_BASENAME; ?>'] td {
				box-shadow: none;
			}
